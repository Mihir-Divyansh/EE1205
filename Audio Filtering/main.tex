...
\vspace{3cm}
\title{Audio Filter}
\author{EE23BTECH11017 - E Mihir Divyansh$^{*}$% <-this % stops a space
}
\maketitle
\newpage
\bigskip
...
\begin{lstlisting}
https://github.com/Mihir-Divyansh/EE1205/blob/main/Audio_%20Filtering/codes/My_Voice.wav
\end{lstlisting}
\item 
\label{Python code}
To filter the given file, we use Python 
\lstinputlisting{./codes/filter.py}\label{audio_filtering}		

\item 
\label{Visualization}
The audio file is put through spectrum analysis using the codes given in 
\begin{lstlisting}
https://github.com/Mihir-Divyansh/EE1205/blob/main/Audio_%20Filtering/codes/spectrum_with_noise.py
https://github.com/Mihir-Divyansh/EE1205/blob/main/Audio_%20Filtering/codes/spectrum_without_noise.py
\end{lstlisting}
\begin{figure}[h]
	\centering
    \includegraphics[width=0.8\columnwidth]{figs/Spectrogram.png }
    \caption{Spectrogram: Pre-Filtering}
    \label{Spectrogram: Pre-Filter}
\end{figure}
\begin{figure}[h]
	\centering
    \includegraphics[width=0.8\columnwidth]{figs/Spectrogram_Reduced_Noise.png}
    \caption{Spectrogram: Post Filtering}
    \label{Spectrogram: Post-Filter}
\end{figure}
...
\end{multline}
Solve for $y(n)$ and Sketch $y(n)$ \\
\solution  The C code calculates $y\brak{n}$ and generates values in a dat file.
\begin{lstlisting}
https://github.com/Mihir-Divyansh/EE1205/tree/main/Audio_%20Filtering/codes/diff_eqn.c
\end{lstlisting} 
The following code plots \eqref{prob:2.1} and \eqref{prob:2.2}
\begin{lstlisting}
https://github.com/Mihir-Divyansh/EE1205/tree/main/Audio_%20Filtering/codes/diff_eqn.py
\end{lstlisting}

\begin{figure}[H]
	\centering
	\includegraphics[width=\columnwidth]{figs/x_n and y_n.png}
...
\begin{lstlisting}
https://github.com/Mihir-Divyansh/EE1205/tree/main/Audio_%20Filtering/codes/Z-transfer.py
\end{lstlisting}
...
\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth]{figs/H(z)_1.png}
...
\begin{lstlisting}
https://github.com/Mihir-Divyansh/EE1205/tree/main/Audio_%20Filtering/codes/4.2.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
%
\begin{lstlisting}
https://github.com/Mihir-Divyansh/EE1205/tree/main/Audio_%20Filtering/codes/y_by_conv.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Mihir-Divyansh/EE1205/tree/main/Audio_%20Filtering/codes/DFT_and_FFT.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Mihir-Divyansh/EE1205/tree/main/Audio_%20Filtering/codes/FFT_and_IFFT.py   
\end{lstlisting}
This code verifies the result by plotting the obtained result with the result obtained by DFT.
\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth]{figs/verify_y_n.png}
...
\end{align}
This product is called the Hadamard product, computes element-wise multiplication.
\end{enumerate}
The below code computes $y\brak{n}$ by DFT Matrix and then plots it.
\begin{lstlisting}
https://github.com/Mihir-Divyansh/EE1205/tree/main/Audio_%20Filtering/codes/5.5.py
\end{lstlisting}
\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth]{figs/y_n_matrix_DFT.png}
...
\section{EXERCISES}
\noindent Answer the following questions by looking at the python code in Problem \ref{audio_filtering}.
...
\begin{lstlisting}
	...
	\end{lstlisting}
in Problem \ref{audio_filtering} is executed through the following difference equation
\begin{equation}
...
\begin{lstlisting}
https://github.com/Mihir-Divyansh/EE1205/tree/main/Audio_%20Filtering/codes/myfilter.py 
\end{lstlisting}
\begin{figure}[H]
\centering
...
\solution The code in \ref{audio_filtering} generates the values of $a$ and $b$  which can be used to generate a difference equation.\\
And,
\begin{align}
    M &= 5\\
    N&=5
...
\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth]{figs/my_h_n.png}
...
\begin{lstlisting}
https://github.com/Mihir-Divyansh/EE1205/tree/main/Audio_%20Filtering/codes/6_filter_response.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
The below code plots the Butterworth Filter in analog domain by using bilinear transform.
    ...
    \end{align}
    \begin{lstlisting}
https://github.com/Mihir-Divyansh/EE1205/blob/main/Audio_Filtering/codes/hn_analog_freq_response.py
    \end{lstlisting}
    \begin{figure}[!h]
    \centering
    \includegraphics[width=0.8\columnwidth]{figs/Analog_Filter_Response.png}
    \caption{Butterworth Filter Frequency response in analog domain}
    \label{fig:H(w)_6}
    \end{figure}
The pole-zero plot of the given filter is plotted using the following code.
\begin{lstlisting}
https://github.com/Mihir_Divyansh/EE1205/blob/main/Audio_Filtering/codes/hn_pole_zero.py
\end{lstlisting}
\begin{figure}[!h]
    \centering
    \includegraphics[width=1\columnwidth]{figs/Pole-Zero Plot.png}
