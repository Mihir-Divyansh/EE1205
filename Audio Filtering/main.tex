...
\lstinputlisting{./codes/1.py}\label{audio_filtering}

\item 
\label{Visualization}
The audio file is put through spectrum analysis using the code given in 
\begin{lstlisting}
https://github.com/Mihir-Divyansh/EE1205/blob/main/Audio_%20Filtering/codes/spectrum.py
\end{lstlisting}
\begin{figure}[h]
	\centering
...
\begin{lstlisting}
https://github.com/Mihir-Divyansh/EE1205/tree/main/Audio_%20Filtering/codes/3.5.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Mihir-Divyansh/EE1205/tree/main/Audio_%20Filtering/codes/6.1.py 
\end{lstlisting}
\begin{figure}[H]
\centering
